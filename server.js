...
let users = [
    {id: 1, username: 'admin', password: '$2$10$...', role: 'admin'},
    {id: 2, username: 'vin', password: '$2$10$...', role: 'user'}
];
...
app.listen(PORT, () => {
    ...
    console.log(`Try loggin in with:`);
    console.log(` -Admin: username=admin, password=admin123`);
    console.log(` -User: username=vin, password=user123`);
});